...
- **Dirac Delta Support:** Handles improper rational functions ($\text{deg}(N) \ge \text{deg}(D)$) with impulse, doublet, and triplet outputs.
...
2. Transfer it to your TI-Nspire CX CAS handheld using the Student Software.
